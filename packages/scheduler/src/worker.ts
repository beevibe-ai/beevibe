 ...
 *      `SessionRepository.claimNextForServerFallback`, and for each: flip
 *      the backing task into its active state (`transitionTaskOnClaim`),
 *      provision the workspace, hand off to `dispatchTask`
 *      (fire-and-forget).
 *
