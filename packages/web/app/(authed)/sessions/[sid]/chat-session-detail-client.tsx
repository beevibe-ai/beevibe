...
import {
  ...
  FooterField,
  MonoFooterField,
} from "@/components/detail/detail-footer";
import { ChatMarkdown } from "@/components/chat/markdown";
import { MetaDot, SessionDetailHeader } from "@/components/sessions/session-header";
  ...
  return (
    <>
      ...
      <DetailFooter>
        ...
        <MonoFooterField label="CLI session" value={lastTurn?.cli_session} />
        <MonoFooterField label="Worktree" value={lastTurn?.worktree} />
