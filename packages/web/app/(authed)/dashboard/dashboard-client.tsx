    ...
    <div className="flex-1 overflow-auto">
      <div className="max-w-6xl mx-auto pt-8 pb-12 px-6">
        <QueryGate
          ...
          noun="dashboard"
          subject="KPIs and fleet status"
          notConfiguredTitle="Dashboard not connected"
          errorDetail="Check that the API server is reachable."
          query={query}
          skeleton={
...
function Body({ data }: { data: DashboardDisplay }) {
